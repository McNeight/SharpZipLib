...
namespace ICSharpCode.SharpZipLib.Tar
{
	...
	public class TarHeader : ICloneable
	{
		...
		/// <summary>
		/// The length of the magic tag in a header buffer.  (includes trailing NULL)
		/// </summary>
		public const int MAGICLEN = 6;

		/// <summary>
		/// The length of the version field in a header buffer.  (does not include trailing NULL)
		/// </summary>
		...
		/// <summary>
		/// The magic tag representing a POSIX 1003.1-1990 tar archive.  (includes trailing NULL)
		/// </summary>
		public const string TMAGIC = "ustar"; /* ustar and a null */

		/// <summary>
		/// The version field representing a POSIX tar archive.  (does not include trailing NULL)
		/// </summary>
		public const string TVERSION = "00"; /* 00 and no null */

		/// <summary>
		/// The magic tag representing an old GNU tar archive where version is included in magic and overwrites it
		/// </summary>
		public const string OLDGNU_MAGIC = "ustar  "; /* 7 chars and a null */
